"""Core AI functionality for Git Tools App."""
...
def get_active_provider():
    ...
    try:
        logger.debug(f"Attempting to load AI provider module: git_tools_app.ai.ai_providers.{provider_name}")
        provider_module = importlib.import_module(f"git_tools_app.ai.ai_providers.{provider_name}")
