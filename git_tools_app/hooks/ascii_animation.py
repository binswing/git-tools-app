"""Hook implementation for ASCII animation in the terminal."""
...
HOOK_SCHEMA = {
    ...
    "options": [
        {"key": "style", "type": "text", "label": "Animation Style (rocket / train)", "default": "rocket"},
        {"key": "speed", "type": "text", "label": "Frame Delay in seconds (e.g., 0.08)", "default": "0.08"},
    ],
}
